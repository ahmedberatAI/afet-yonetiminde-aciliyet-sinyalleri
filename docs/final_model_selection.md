...
Aşağıdakiler canonical DEĞİLDİR; referans/audit için saklanıyor:

- `data/analysis/experiment_comparison_v2.*` — silver pool contaminated (1934/1934 gold id içeriyordu); kullanmayın.
- `models/final/selection_historical_v1_gold_combined_weighted.json` — v1 önizleme seçimi (F1-macro=0.309).
- `data/predictions/need_predictions_geolocated_63k.csv`, `need_predictions_geolocated_gold_combined_weighted.csv`, `need_predictions_geolocated_v1_gold_combined_weighted.csv` — eski prediction pas'ları; canonical değil.
